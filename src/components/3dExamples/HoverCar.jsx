...
Command: npx gltfjsx@6.5.3 free_cyberpunk_hovercar.glb
...
export function HoverCar(props) {
  ...
  const colors = {
    body: new THREE.Color('#041c5c'),       // bright blue
    metal: new THREE.Color('#b8b8b8'),      // silver
    plastic: new THREE.Color('#1b1b1b'),    // dark gray
    light: new THREE.Color('#00ffff'),      // cyan
    gloss: new THREE.Color('#3c3c3c'),      // medium gray
    thruster: new THREE.Color('#ff3300'),   // orange-red
    accent1: new THREE.Color('#ff00ff'),    // magenta
    accent2: new THREE.Color('#ffff00')     // yellow
  }
  ...
  const colorizeModel = () => {
    // First, update material definitions if they exist
    if (materials.cdp_body) materials.cdp_body.color.set(colors.body)
    if (materials.cdp_metal) materials.cdp_metal.color.set(colors.metal)
    if (materials.cdp_plastic) materials.cdp_plastic.color.set(colors.plastic)
    if (materials.white_light) {
      materials.white_light.color.set(colors.light)
      materials.white_light.emissive = colors.light
      materials.white_light.emissiveIntensity = 1
    }
    if (materials.gloss) materials.gloss.color.set(colors.gloss)
    if (materials.thruster) {
      materials.thruster.color.set(colors.thruster)
      materials.thruster.emissive = colors.thruster
      materials.thruster.emissiveIntensity = 1
    }
      ...
      if (object.isMesh) {
        ...
        if (Array.isArray(object.material)) {
          object.material.forEach(mat => {
            applyMaterialColor(mat, object.name)
          })
        }
        // If it's a single material
        else if (object.material) {
          applyMaterialColor(object.material, object.name)
        }
      }
    })
  }

  const applyMaterialColor = (material, name) => {
    // Make sure all materials have these basic properties
    material.roughness = material.roughness || 0.5
    material.metalness = material.metalness || 0.5

    // Based on material name or mesh name
    if (!material.colorApplied) {  // Prevent applying colors multiple times
      // Determine what type of part this is and color accordingly
      if (material.name?.includes('body') || name?.includes('body')) {
        material.color = colors.body.clone()
        material.roughness = 0.3
        material.metalness = 0.8
      }
      else if (material.name?.includes('metal') || name?.includes('metal')) {
        material.color = colors.metal.clone()
        material.roughness = 0.2
        material.metalness = 1.0
      }
      else if (material.name?.includes('plastic') || name?.includes('plastic')) {
        material.color = colors.plastic.clone()
        material.roughness = 0.9
        material.metalness = 0.1
      }
      else if (material.name?.includes('light') || name?.includes('light')) {
        material.color = colors.light.clone()
        material.emissive = colors.light.clone()
        material.emissiveIntensity = 1
        material.roughness = 0.2
      }
      else if (material.name?.includes('gloss') || name?.includes('gloss')) {
        material.color = colors.gloss.clone()
        material.roughness = 0.1
        material.metalness = 0.9
      }
      else if (material.name?.includes('thruster') || name?.includes('thruster')) {
        material.color = colors.thruster.clone()
        material.emissive = colors.thruster.clone()
        material.emissiveIntensity = 1
        material.roughness = 0.5
      }
      // Default color if can't determine type
      else {
        material.color = colors.metal.clone()
        material.roughness = 0.5
      ...
      material.colorApplied = true  // Mark as processed
      material.needsUpdate = true   // Important to apply changes
    }
  }

  // Add a hover effect animation
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={0.208}>
          <group name="Root">
            <group name="Cylinder" position={[5.773, -2.749, 1.017]} rotation={[0, -0.349, -1.215]} scale={0.131}>
              <mesh name="Cylinder_0" geometry={nodes.Cylinder_0.geometry} material={materials.cdp_metal} />
            </group>
            <group name="Cylinder001" position={[5.965, -3.927, 1.485]} rotation={[0, -0.349, -1.215]} scale={0.131}>
              <group name="Cylinder005" position={[21.97, -12.672, -2.085]} rotation={[0.001, -0.001, -1.773]} scale={6.122}>
            ...
            <group name="Cylinder003" position={[4.836, -0.934, 0.803]} rotation={[0, -Math.PI / 9, 0.053]} scale={0.801}>
            ...
            <group name="Cylinder006" position={[2.514, -10.75, 1.388]} rotation={[-1.8, 1.145, 1.513]} scale={0.175}>
            ...
            <group name="Cylinder012" position={[5.289, 4.289, 1.612]} rotation={[-0.873, 0, 0]}>
              <group name="Cylinder004" position={[0, 1.635, -0.547]} rotation={[0, Math.PI / 2, 0]}>
                <group name="Torus000" position={[0.001, 2.419, -0.027]} rotation={[-1.584, -1.549, -1.584]} scale={[1.266, 1, 1]}>
            ...
            <group name="Cylinder023" position={[5.965, -3.927, 1.485]} rotation={[0, -0.349, -1.215]} scale={0.131}>
              <mesh name="Cylinder023_0" geometry={nodes.Cylinder023_0.geometry} material={materials.cdp_metal} />
            </group>
            <group name="Cube011" position={[1.458, 14.952, 3.951]} rotation={[0.066, 0, 0.005]} scale={[1.009, 1.09, 1.009]}>
            ...
            <group name="Cylinder009" position={[0, -10.001, 1.024]} rotation={[-0.698, 0, 0]}>
              <group name="Cylinder010" position={[0, 1.435, -0.547]} rotation={[0, 1.571, 0]}>
                <group name="Torus001" position={[0, 2.42, 0]} rotation={[0, -Math.PI / 2, 0]} scale={[1.266, 1, 1]}>
            ...
            <group name="Cylinder011" position={[0, -7.4, 1.587]} rotation={[2.197, 0, 0]} scale={0.644}>
            ...
            <group name="Cylinder021" position={[-5.289, 4.289, 1.612]} rotation={[-0.873, 0, 0]}>
              <group name="Cylinder022" position={[0.001, 1.641, -0.53]} rotation={[Math.PI / 2, 0, 0]}>
                <group name="Torus002" position={[0.008, -0.001, -2.419]} rotation={[1.549, 0, -0.008]}>
            ...
            <group name="Cylinder024" position={[-2.514, -10.75, 1.388]} rotation={[1.342, 1.145, 1.513]}>
            ...
            <group name="Cylinder025" position={[-4.836, -0.934, 0.803]} rotation={[Math.PI, -Math.PI / 9, 0.053]}>
            ...
            <group name="Cylinder026" position={[-5.965, -3.927, 1.485]} rotation={[3.142, -0.349, -1.215]}>
              <group name="Cylinder027" position={[-2.875, 1.659, 0.273]} rotation={[0.001, -0.001, -1.773]}>
            ...
            <group name="Cylinder028" position={[-5.773, -2.749, 1.017]} rotation={[3.142, -0.349, -1.215]}>
              <mesh name="Cylinder028_0" geometry={nodes.Cylinder028_0.geometry} material={materials.cdp_metal} />
            </group>
            <group name="Cylinder014" position={[-4.761, 11.355, 3.661]} rotation={[-2.984, 0.086, 0.181]}>
            ...
            <group name="Cylinder013" position={[-3.821, 14.727, 4.705]} rotation={[3.137, 0.421, 0.228]}>
            ...
            <group name="Plane005" visible={false}>
            ...
            <group name="Cube010" position={[5.638, 0.672, 3.939]} rotation={[0.062, 0.041, -0.035]} scale={[0.896, 1.767, 0.799]}>
            ...
            <group name="Cylinder002" position={[5.773, -2.749, 1.017]} rotation={[0, -0.349, 0.094]} scale={0.131}>
              <mesh name="Cylinder002_0" geometry={nodes.Cylinder002_0.geometry} material={materials.cdp_metal} />
            </group>
            <group name="Cylinder007" position={[2.413, -10.795, 1.399]} rotation={[1.342, -1.145, -1.811]} scale={0.175}>
            ...
            <group name="Cylinder017" position={[4.761, 11.355, 3.661]} rotation={[0.205, -0.172, 0.183]}>
            ...
            <group name="Cylinder018" position={[3.821, 14.727, 4.705]} rotation={[-0.237, 0.99, 0.386]}>
            ...
            <group name="Cube006" position={[2.812, -6.537, 0.418]} rotation={[0, 0, -1.553]} scale={0.919}>
            ...
            <group name="Cube001" position={[2.812, -6.537, 0.418]} rotation={[0, 0, -1.553]} scale={0.919}>
              <mesh name="Cube001_0" geometry={nodes.Cube001_0.geometry} material={materials.cdp_metal} />
            </group>
            <group name="Cube007" position={[1.458, 14.952, 3.951]} rotation={[0.066, 0, 0.005]} scale={[1.009, 1.09, 1.009]}>
